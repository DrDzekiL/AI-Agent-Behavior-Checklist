...
Author: DV09 Status: Public / Open Purpose: Define safe, predictable, and responsible behavior for AI agents operating in real-world environments.
...
An agent should not be brave. It should be reliable.

Boundaries of Autonomy (Permission Scenarios)
...
Behavior Under Failure (Failure Scenarios)
...
Trust Decay (Trust-Decay Scenarios)
...
Escalation and Stop (Escalation Scenarios)
